...
export default function ProdsOutOfStock() {
  ...
  const [currentPage, setCurrentPage] = useState(1);
    ...
    let getCatName = fullUrl.split("/products/out-of-stock/").pop();
    ...
    return (
      <>
      {
        ...
        <html>
          <head>
            <title>Bakht'Art - Products Out Of Stock {
              bakhtartCats.map((itemc => (
                itemc.categoryPath === getCatName ?
                <>{itemc.categoryName} (Out Of Stock)</> : <></>
              )))
              } {
                getCatName === 'all' ?
  ...
  font-weight: bold;\
    ...
    position: relative;\
      ...
      `}
        ...
        <span style={{marginLeft: '500px', color: 'red', fontWeight: 'bold',
        fontFamily: 'Felix Titling'}}>Login required to access cart</span>
          </>
        }
        {
            userrData.userr ?
            ...
            <div className="row">
                <div className="col-md-12">
                    <div className="product-bit-title text-center">
                        <h2 style={{fontFamily: 'Felix Titling', color: 'white'}}>Shop - Out Of Stock</h2>
                    </div>
                </div>
            </div>
        </div>
                                ...
                                <ul className="categiri">
...

                                   {
                                       bakhtartCats.map((itemc => (
                                           ...
                                           <>
                                            <li className="active">
                                                <a href={`/products/out-of-stock/${itemc.categoryPath}`}
                                                style={{color: '#D3BE06', fontFamily: 'Felix Titling'}}>
                                            {itemc.categoryName}
                                            </a></li>
                                           </> : <>
...
{`\
  ...
  color: #070C29;\
    ...
    <div className="single-product-area">
        ...
        <div className="container">
        {
                nb_out === 0 && getCatName !== 'all' ?
                <div align = "center">
                <h4 style={{fontFamily: 'Felix Titling', fontWeight: 'bold',
                color: '#021144'}}>This Category doesn't have products out of stock.</h4>
                </div> : <></>
              }
              {
                nb_out === 0 && getCatName === 'all' ?
                <div align = "center">
                <h4 style={{fontFamily: 'Felix Titling', fontWeight: 'bold',
                color: '#021144'}}>No Product is out of stock.</h4>
                </div> : <></>
              }
              {
              ...
              
            {
                    currentTableData.filter((item=>{
                      if (searchitem === "") {
                        ...
                        getCatName === 'all' && itemp.productQuantity === 0 ?
                        <>
                ...
                }
                {
                    currentTableData.filter((item=>{
                      if (searchitem === "") {
                        ...
                        itemp.productCategory === getCatName && itemp.productQuantity === 0 ?
                        <>
                        <div className="col-md-3 col-sm-6" key = {itemp._id}>
                    <div className="single-shop-product">
                        <div className="product-upper">
