...
export default function ProdsInSale() {
  ...
  const [currentPage, setCurrentPage] = useState(1);
    ...
    let getCatName = fullUrl.split("/products/in-sale/").pop();
    ...
    return (
      <>
      {
        ...
        <html>
          <head>
            <title>Bakht'Art - Products In Sale {
              bakhtartCats.map((itemc => (
                itemc.categoryPath === getCatName ?
                <>{itemc.categoryName} (In Sale)</> : <></>
              )))
              } {
                getCatName === 'all' ?
            ...
            <div className="row">
                <div className="col-md-12">
                    <div className="product-bit-title text-center">
                        <h2 style={{fontFamily: 'Felix Titling', color: 'white'}}>Shop - In Sale</h2>
                    </div>
                </div>
            </div>
        </div>
                                ...
                                <ul className="categiri">
...

                                   {
                                       bakhtartCats.map((itemc => (
                                           ...
                                           <>
                                            <li className="active">
                                                <a href={`/products/in-sale/${itemc.categoryPath}`}
                                                style={{color: '#D3BE06', fontFamily: 'Felix Titling'}}>
                                            {itemc.categoryName}
                                            </a></li>
                                           </> : <>
